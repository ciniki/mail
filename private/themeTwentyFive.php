...
// <rsp stat="ok" />
//
function ciniki_mail_themeTwentyFive($ciniki, $tnid) {
    return array('stat'=>'ok', 'theme'=>array(
        ...
        'title_style'=>'padding: 0px; margin-top: 10px; margin-bottom: 0px; font-size: 22px; font-family: Helvetica, sans-serif; line-height: 25px;',
        'subtitle_style'=>'font-size: 14px; font-family: Helvetica, sans-serif; line-height: 28px;',
        'logo_style'=>'',
        ...
        'h1'=>'text-decoration: bold; font-size: 20px; font-family: Helvetica, sans-serif;',
        'h2'=>'text-decoration: bold; font-size: 18; font-family: Helvetica, sans-serif;',
        'h3'=>'text-decoration: bold; font-size: 16px; font-family: Helvetica, sans-serif;',
        'h4'=>'text-decoration: bold; font-size: 14px; font-family: Helvetica, sans-serif;',
        ...
        'td'=>'border: 0px solid #ddd; border-bottom: 1px solid #ddd; padding: 5px 10px;',
        'th'=>'border: 0px solid #ddd; border-bottom: 1px solid #ddd; background: #eee; padding: 5px 10px;',
        ));
}
?>
