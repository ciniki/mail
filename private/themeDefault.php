...
function ciniki_mail_themeDefault($ciniki, $business_id) {
	return array('stat'=>'ok', 'theme'=>array(
		...
		'header_style'=>"body {margin: 0px; font-family: Helvetica, sans-serif; font-size: 14px;}\n"
			...
			. "",
		'wrapper_style'=>"background-color: #000;",
		'title_style'=>'font-size: 16px Helvetica, sans-serif; line-height: 20px; color: #aaffff;',
		'subtitle_style'=>'font-size: 14px Helvetica, sans-serif; line-height: 28px; color: #aaffff;',
		'logo_style'=>'',
