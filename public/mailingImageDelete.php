...
// <rsp stat='ok' />
//
function ciniki_mail_mailingImageDelete(&$ciniki) {
    //  
    ...
    $rc = ciniki_mail_checkAccess($ciniki, $args['business_id'], 'ciniki.mail.mailingImageDelete'); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }   
    ...
    //
    $strsql = "SELECT id, uuid FROM ciniki_mailing_images "
    ...
    return ciniki_core_objectDelete($ciniki, $args['business_id'], 'ciniki.mail.mailing_image', $args['mailing_image_id'], $item['uuid'], 0x07);
}
?>
