...
function ciniki_mail_mailingImageDelete(&$ciniki) {
    ...
    $rc = ciniki_mail_checkAccess($ciniki, $args['tnid'], 'ciniki.mail.mailingImageDelete'); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }   
    ...
    return ciniki_core_objectDelete($ciniki, $args['tnid'], 'ciniki.mail.mailing_image', $args['mailing_image_id'], $item['uuid'], 0x07);
}
?>
