...
function ciniki_mail_mailingImageHistory($ciniki) {
    ...
    $rc = ciniki_mail_checkAccess($ciniki, $args['business_id'], 'ciniki.mail.mailingImageHistory');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    return ciniki_core_dbGetModuleHistory($ciniki, 'ciniki.mail', 'ciniki_mail_history', 
        $args['business_id'], 'ciniki_mailing_images', $args['mailing_image_id'], $args['field']);
}
?>
